...
const VERSION_HISTORY = [
    ...
    },
    {
        ...
        changes: [
            ...
            'Improved: Navigation requests now use network-first strategy to avoid stale HTML shell',
            'Updated: Main app version to v1.22.0',
        ],
    },
    {
        version: '1.21.0',
        date: '2026-02-16',
        title: 'Firebase Email Auth + Visible Expansion Entry',
        current: false,
        changes: [
            'Added: Firebase email/password authentication controls in Settings (sign up, sign in, sign out)',
            'Improved: Firestore sync now scopes data by authenticated userId and queues writes until sign-in completes',
            'Added: Always-visible Expansion launch icon in the Home header to ensure the link is discoverable',
            'Updated: Main app version to v1.21.0',
        ],
    },
    {
        version: '1.20.0',
